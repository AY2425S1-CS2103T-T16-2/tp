...
with(this){return _c('ol',[_c('li',[_v("Real estate agent requests to add a meeting based on the meeting’s meeting title and meeting date. The real estate agent also specifies the buyer, seller, and property involved in this meeting.")]),_v(" "),_c('li',[_v("ClientGrid will add the meeting and indicate success.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. ClientGrid detects an error in the meeting title or meeting date format provided by the real estate agent.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. ClientGrid requests for the correct data.")])]),_v(" "),_c('li',[_c('p',[_v("1a2. Real estate agent enters new data.")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1a1-1a2 are repeated until the data entered are correct.")])]),_v(" "),_c('li',[_c('p',[_v("Use case resumes from step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. ClientGrid is unable to find a matching buyer, seller, or property entry in the meeting book.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. ClientGrid informs real estate agent that the buyer, seller, or property does not exist in the meeting book.")])]),_v(" "),_c('li',[_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 clients and 500 properties without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The client and property databases should be updated after every command successfully executed by ClientGrid.")]),_v(" "),_c('li',[_v("Should be able to handle case of corrupted file")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Clients")]),_v(": Buyers or Sellers of properties the real estate agent is managing")]),_v(" "),_c('li',[_c('strong',[_v("Client Book")]),_v(": In-memory JSON file containing the clients stored in ClientGrid")]),_v(" "),_c('li',[_c('strong',[_v("Property Book")]),_v(": In-memory JSON file containing the properties stored in ClientGrid")]),_v(" "),_c('li',[_c('strong',[_v("Meeting Book")]),_v(": In-memory JSON file containing the meetings stored in ClientGrid")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Corrupted file")]),_v(": Missing file and invalid data")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 30 Oct 2024, 23:46:53 GMT+8]")])])])}
}];
