...
with(this){return _c('h3',{attrs:{"id":"add-buyer-feature"}},[_v("Add Buyer Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#add-buyer-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC1 - Add Client (Buyer or Seller)")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC2 - List Clients (i.e. Buyers and/or Sellers), Properties or Meetings")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC4 - Delete Client (Buyer or Seller)")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("If the buyer/ seller was in the database originally, it would be removed from client database with no side effects.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. ClientGrid detects an error in the format of the meeting title, meeting date, buyer phone number, seller phone number, property type, or postal code provided by the real estate agent.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. ClientGrid requests for the correct data.")])]),_v(" "),_c('li',[_c('p',[_v("1a2. Real estate agent enters new data.")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1a1-1a2 are repeated until the data entered are correct.")])]),_v(" "),_c('li',[_c('p',[_v("Use case resumes from step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. ClientGrid detects there is a meeting of the same meeting title and meeting date in the client book.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. ClientGrid notifies the user of an existing meeting with the same title and date in the client book and prompts the user to modify either the meeting title or date before resubmitting.")])]),_v(" "),_c('li',[_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. ClientGrid is unable to find a matching buyer, seller, or property entry in the ClientBook or PropertyBook.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. ClientGrid informs real estate agent that the buyer, seller, or property does not exist in the ClientBook or PropertyBook.")])]),_v(" "),_c('li',[_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 31 Oct 2024, 17:17:43 GMT+8]")])])])}
}];
